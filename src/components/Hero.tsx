  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-white">
      ...
      >
        ...
        <h1 className="mix-blend-exclusion bg-blend-difference absolute bottom-5 right-5 uppercase font-black sm:right-10 sm:text-7xl md:text-9xl lg:text-[12rem] z-[60] pointer-events-none">
          Gaming
        </h1>
